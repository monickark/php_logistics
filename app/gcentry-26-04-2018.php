...
if($_POST['home_halt_advance']!=0)
{
$type="1";
$reason="Home Halt Advance";

 $ins_driver_mgt = array(
        "intAdminId"       =>     mysqli_real_escape_string($data->con, $_SESSION['MintId']),
        "ent_date"         =>     mysqli_real_escape_string($data->con, $newDate),
        "driver_id"        =>     mysqli_real_escape_string($data->con, $_POST['home_halt_driver']),
        "amount"           =>     mysqli_real_escape_string($data->con, $_POST['home_halt_advance'+ $_POST['home_halt_mkm']]),
        "type"             =>     mysqli_real_escape_string($data->con, $type), 
        "reason"           =>     mysqli_real_escape_string($data->con, $reason)
      ); 
 $inshhaltid = $data->insert('driver_mgt', $ins_driver_mgt);
...
<div class="row mg-t-10">
      ...
      <div class="row mg-t-10">
        ...
        <label class="col-md-3 col-sm-3 form-control-label">Price Per Litre</label>
        <div class="col-sm-2 mg-t-5 mg-sm-b-10">
          <input class="form-control" data-val="true" data-val-length="The field permitno must be a string with a maximum length of 50." data-val-length-max="50" placeholder="0" id="returne_upd_ppl" maxlength="50" name="returne_upd_ppl" type="text" value="" disabled>
...
<div id="hhaltent">
 ...
 <!--    <script>
     $(document).ready(function(){
  $("#hhdriver").keyup(function(){
    $.ajax({
    type: "POST",
    url: "driversuggest.php",
    data:'keyword='+$(this).val(),
    beforeSend: function(){
      $("#hhdriver").css("background","#FFF url(LoaderIcon.gif) no-repeat 300px");
    },
    success: function(data){
      $("#hhdriverli").show();
      $("#hhdriverli").html(data);
      $("#hhdriver").css("background","#FFF");
    }
    });
  });
});
         ...
         <div class="row mg-t-10">
          <label class="col-md-4 form-control-label"> Driver Advance </label>
          <div class="col-sm-8 mg-t-10 mg-sm-b-10">
            <input class="form-control" data-val="true" data-val-length="The field permitno must be a string with a maximum length of 50." data-val-length-max="50" placeholder="Chennai" id="hltplace" maxlength="50" name="home_halt_advance" type="text" value="" >
            <span class="field-validation-valid font-red" data-valmsg-for="permitno" data-valmsg-replace="true"></span>
          </div>
        </div>
...
<div class="row mg-t-10">
          <label class="col-md-4 form-control-label"> Driver Advance </label>
          <div class="col-sm-8 mg-t-10 mg-sm-b-10">
            <input class="form-control" data-val="true" data-val-length="The field permitno must be a string with a maximum length of 50." data-val-length-max="50" placeholder="MKM" id="home_halt_mkm" maxlength="50" name="home_halt_mkm" type="number" value="" >
            <span class="field-validation-valid font-red" data-valmsg-for="permitno" data-valmsg-replace="true"></span>
          </div>
        </div>
...
<div id="dieseldiv_homehalt">
 ...
 <div class="card  pd-sm-t-10 pd-sm-b-10 pd-sm-l-0 mg-l-0">
       ...
       <div class="row row-sm mg-t-0 pd-sm-l-30 pd-sm-r-30">
          ...
          <div class="col-xl-12 col-md-12 mg-l-0 pd-sm-l-0-force pd-sm-r-0-force">
            ...
            <div class="portlet-body">     
      <div align="right" style="float: right;">
     <button type="button" name="add" id="add_die_homehalt" class="btn btn-info">Add New Entry</button>
    </div>
       <div class="mg-t-10 col-sm-8 pd-sm-l-0 pd-sm-r-0 pd-sm-t-15"> 
             <h6 class="card-body-title">Diesel Entries</h6>
           </div>
 ...
 <div class="col-sm-12 mg-t-30 pd-sm-l-0 pd-sm-r-0" id="responsecontainer_homehalt">
 ...
 <div class="col-xl">
                   ...
                   <div class="modal fade" id="homehalt_die_add" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
<div class="modal-dialog">
<div class="modal-content">
<div class="modal-header">
<!-- <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button> -->
...
<div class="row mg-t-10">
          ...
          <div class="col-sm-8 mg-t-5 mg-sm-b-10 ">
           <div class="input-group">
              <span class="input-group-addon"><i class="icon ion-calendar tx-16 lh-0 op-6"></i></span>
              <input class="form-control datepicker" placeholder="Cash Date" name="hire_friet_adv_cash_date" id="datepicker_homehalt" type="text" value="<?php echo date('d/m/Y');?>" >
            </div>
        </div>
      </div>
       ...
       <div class="row mg-t-10">
        <label class="col-md-4 col-sm-4 form-control-label">Vechicle Number</label>
        <div class="col-sm-8 mg-t-5 mg-sm-b-10">
          <input class="form-control" data-val="true" data-val-length="The field engineno must be a string with a maximum length of 50." data-val-length-max="50" placeholder="Driver Name" id="homehalt_die_vechno" maxlength="50" name="homehalt_driver" type="text"  disabled>
          <span class="field-validation-valid font-red" data-valmsg-for="engineno" data-valmsg-replace="true"></span>
        </div>
      </div>  
      ...
      <div class="row mg-t-10">
        <label class="col-md-4 col-sm-4 form-control-label">Driver</label>
        <div class="col-sm-8 mg-t-5 mg-sm-b-10">
          <input class="form-control" data-val="true" data-val-length="The field engineno must be a string with a maximum length of 50." data-val-length-max="50" placeholder="Driver Name" id="homehalt_die_driver" maxlength="50" name="driver" type="text" value="" disabled>
             <input class="form-control" data-val="true" data-val-length="The field engineno must be a string with a maximum length of 50." data-val-length-max="50" placeholder="Driver Name" id="homehalt_die_driver_id" maxlength="50" name="homehalt_die_driver_id" type="hidden">
          <span class="field-validation-valid font-red" data-valmsg-for="engineno" data-valmsg-replace="true"></span>
        </div>
      </div>  
      ...
      <div class="row mg-t-10">
        <label class="col-md-4 col-sm-4 form-control-label">Vendor</label>
        <div class="col-sm-8 mg-t-5 mg-sm-b-10">
          <input class="form-control" data-val="true" data-val-length="The field engineno must be a string with a maximum length of 50." data-val-length-max="50" placeholder="Vendor Name" id="homehalt_die_vendor" maxlength="50" name="vendor" type="text" value="">
          <span class="field-validation-valid font-red" data-valmsg-for="engineno" data-valmsg-replace="true"></span>
        </div>
      </div>
<div class="row mg-t-10">
        <label class="col-md-4 col-sm-4 form-control-label">Place</label>
        <div class="col-sm-8 mg-t-5 mg-sm-b-10">
<!--           <input class="form-control" data-val="true" data-val-length="The field engineno must be a string with a maximum length of 50." data-val-length-max="50" placeholder="Vendor Location" id="homehalt_die_place" maxlength="50" name="place" type="text" value=""> -->
        
<?php
$vendor=mysqli_query($conn,"SELECT * from ledger WHERE nature='Diesel Station'; "); 

?>
<select class="form-control" data-val="true" placeholder="Vendor Name" id="homehalt_die_place" name="vendor" >
<?php
...
?>
      ...
      <div class="row mg-t-10">
        <label class="col-md-4 col-sm-4 form-control-label">Quantity</label>
        <div class="col-sm-3 mg-t-5 mg-sm-b-10">
          <input class="form-control" data-val="true" data-val-length="The field insurancename must be a string with a maximum length of 200." data-val-length-max="200" placeholder="Quantity" id="homehalt_die_qty" maxlength="200" name="qty" type="text" value="" onkeyup="diecalReta1()">
          <span class="field-validation-valid font-red" data-valmsg-for="insurancename" data-valmsg-replace="true"></span>
        </div>

        <label class="col-md-3 col-sm-3 form-control-label">Price Per Litre</label>
        <div class="col-sm-2 mg-t-5 mg-sm-b-10">
          <input class="form-control" data-val="true" data-val-length="The field permitno must be a string with a maximum length of 50." data-val-length-max="50" placeholder="0" id="homehalt_die_ppl" maxlength="50" name="ppl" type="text" value="" disabled>
          <span class="field-validation-valid font-red" data-valmsg-for="permitno" data-valmsg-replace="true"></span>
        </div>
      </div>
      <div class="row mg-t-10">
        <label class="col-md-4 col-sm-4 form-control-label">Amount</label>
        <div class="col-sm-8 mg-t-5 mg-sm-b-10">
          <input class="form-control" data-val="true" data-val-length="The field insurancename must be a string with a maximum length of 200." data-val-length-max="200" placeholder="Diesel Amount" id="homehalt_die_amt" maxlength="200" name="amt" type="text" value="" onkeyup="diecalReta1()">
          <span class="field-validation-valid font-red" data-valmsg-for="insurancename" data-valmsg-replace="true" ></span>
        </div>
      </div>
 ...
 <div class="row mg-t-10">
        ...
        <div class="col-sm-8 mg-t-5 mg-sm-b-10">
          ...
          <select class="form-control valid" data-val="true" placeholder="Select bilty paid type" id="homehalt_die_billtype" name="billtype" style="padding:0px 6px !important;">
            <option <?php if($insid[0]['billtype']=="To Be Billed") echo 'selected="selected"'; ?> value="Cash">Cash</option>
            <option <?php if($insid[0]['billtype']=="Paid") echo 'selected="selected"'; ?> value="Credit">Credit</option>
...
<div class="modal-footer pd-r-0">
<button type="button"  class="btn btn-default" data-dismiss="modal">Close</button>
<button type="button" id="homehalt_die_insert" class="btn btn-primary">Save changes</button>
</div>
</div>
</div> </div>
   ...
   <div class="modal fade" id="homehalt_editModel" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
<div class="modal-dialog">
<div class="modal-content">
<div class="modal-header">
<!-- <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button> -->
...
<input   name="upd_id" id="homehalt_upd_id" type="hidden"  >
<div class="row mg-t-10">
          <label class="col-md-4 col-sm-4 form-control-label">Date</label>
          <div class="col-sm-8 mg-t-5 mg-sm-b-10 ">
           <div class="input-group">
              <span class="input-group-addon"><i class="icon ion-calendar tx-16 lh-0 op-6"></i></span>
              <input class="form-control datepicker" placeholder="Cash Date" name="datepicker_ret_edit" id="datepicker_homehalt_edit" type="text"  >
            </div>
        </div>
      </div>
      ...
      <div class="row mg-t-10">
        <label class="col-md-4 col-sm-4 form-control-label">Driver</label>
        <div class="col-sm-8 mg-t-5 mg-sm-b-10">
          <input class="form-control" data-val="true" data-val-length="The field engineno must be a string with a maximum length of 50." data-val-length-max="50" placeholder="Driver Name" id="homehalt_upd_driver" maxlength="50" name="upd_driver" type="hidden"  disabled>
          <span class="field-validation-valid font-red" data-valmsg-for="engineno" data-valmsg-replace="true"></span>
        </div>
      </div>  
      ...
      <div class="row mg-t-10">
        <label class="col-md-4 col-sm-4 form-control-label">Vendor</label>
        <div class="col-sm-8 mg-t-5 mg-sm-b-10">
<!--           <input class="form-control" data-val="true" data-val-length="The field engineno must be a string with a maximum length of 50." data-val-length-max="50" placeholder="Vendor Name" id="homehalt_upd_vendor" maxlength="50" name="upd_vendor" type="text" > -->
...
?>
<select class="form-control" data-val="true" placeholder="Vendor Name" id="homehalt_upd_vendor" name="upd_vendor" >
<?php
...
<div class="row mg-t-10">
        <label class="col-md-4 col-sm-4 form-control-label">Place</label>
        <div class="col-sm-8 mg-t-5 mg-sm-b-10">
          <input class="form-control" data-val="true" data-val-length="The field engineno must be a string with a maximum length of 50." data-val-length-max="50" placeholder="Vendor Location" id="homehalt_upd_place" maxlength="50" name="upd_place" type="text">
          <span class="field-validation-valid font-red" data-valmsg-for="engineno" data-valmsg-replace="true"></span>
        </div>
      </div>
      ...
      <div class="row mg-t-10">
        <label class="col-md-4 col-sm-4 form-control-label">Quantity</label>
        <div class="col-sm-3 mg-t-5 mg-sm-b-10">
          <input class="form-control" data-val="true" data-val-length="The field insurancename must be a string with a maximum length of 200." data-val-length-max="200" placeholder="Quantity" id="homehalt_upd_qty" maxlength="200" name="upd_qty" type="text"  onkeyup="diecalReta222()">
          <span class="field-validation-valid font-red" data-valmsg-for="insurancename" data-valmsg-replace="true"></span>
        </div>

        <label class="col-md-3 col-sm-3 form-control-label">Price Per Litre</label>
        <div class="col-sm-2 mg-t-5 mg-sm-b-10">
          <input class="form-control" data-val="true" data-val-length="The field permitno must be a string with a maximum length of 50." data-val-length-max="50" placeholder="0" id="homehalt_upd_ppl" maxlength="50" name="homehalt_upd_ppl" type="text" value="" disabled>
          <input class="form-control" data-val="true" data-val-length="The field permitno must be a string with a maximum length of 50." data-val-length-max="50" placeholder="0" id="pplh" maxlength="50" name="pplh" type="hidden" value="" >
          <span class="field-validation-valid font-red" data-valmsg-for="permitno" data-valmsg-replace="true"></span>
        </div>
      </div>
      <div class="row mg-t-10">
        <label class="col-md-4 col-sm-4 form-control-label">Amount</label>
        <div class="col-sm-8 mg-t-5 mg-sm-b-10">
          <input class="form-control" data-val="true" data-val-length="The field insurancename must be a string with a maximum length of 200." data-val-length-max="200" placeholder="Diesel Amount" id="homehalt_upd_amt" maxlength="200" name="upd_amt" type="text" onkeyup="diecalReta222()">
          <span class="field-validation-valid font-red" data-valmsg-for="insurancename" data-valmsg-replace="true" ></span>
        </div>
      </div>
 ...
 <div class="row mg-t-10">
        ...
        <div class="col-sm-8 mg-t-5 mg-sm-b-10">
          ...
          <select class="form-control valid" data-val="true" placeholder="Select bilty paid type" id="homehalt_upd_billtype" name="upd_billtype" style="padding:0px 6px !important;">
            <option <?php if($insid[0]['billtype']=="To Be Billed") echo 'selected="selected"'; ?> value="Cash">Cash</option>
            <option <?php if($insid[0]['billtype']=="Paid") echo 'selected="selected"'; ?> value="Credit">Credit</option>
...
<div class="modal-footer pd-r-0">
<button type="button"  class="btn btn-default" data-dismiss="modal">Close</button>
<button type="button" id="homehalt_update" class="btn btn-primary">Save changes</button>
</div>
</div>
</div>
</div>
 ...
 <script >
$(function () {
$("#add_die_homehalt").click(function(){
$('#homehalt_die_add').modal('show');
var dte=$('#myVariable').val();
$('#datepicker_homehalt').val(dte);
...
<script>
  ...
  $(document).on('click', '#homehalt_update', function(){
   var dat = $('#datepicker_homehalt_edit').val();
   var fid = $('#homehalt_upd_id').val();
   var dri = $('#homehalt_upd_driver').val();
   var ven = $('#homehalt_upd_vendor').val();
   var pla = $('#homehalt_upd_place').val();
   var qt = $('#homehalt_upd_qty').val();
   var pp = $('#homehalt_upd_ppl').val();
   var at = $('#homehalt_upd_amt').val();
   var bill = $('#homehalt_upd_billtype').val();
   var vech="";
...
$.ajax({
    ...
    /*  alert(data);*/
      fetch_data();
      $('#homehalt_editModel').modal('hide');

   $('#homehalt_upd_vendor').val("");
   $('#homehalt_upd_place').val("");
   $('#homehalt_upd_qty').val("");
   $('#homehalt_upd_ppl').val("");
   $('#homehalt_upd_amt').val("");
   $('#homehalt_upd_billtype').val("");
...
<script>
  ...
  $(document).on('click', '#homehalt_die_insert', function(){



   var dat = $('#datepicker_homehalt').val();
   var vno = $('#mVechno').val();
   var tid = $('#homehalt_tripid').val();
   var dri = $('#homehalt_die_driver_id').val();
   var ven = $('#homehalt_die_vendor').val();
   var pla = $('#homehalt_die_place').val();
   var qt = $('#homehalt_die_qty').val();
   var pp = $('#homehalt_die_ppl').val();
   var at = $('#homehalt_die_amt').val();
   var bill = $('#homehalt_die_billtype').val();
...
$.ajax({
   ...
   $('#homehalt_die_vendor').val("");
   $('#homehalt_die_place').val("");
   $('#homehalt_die_qty').val("");
   $('#homehalt_die_ppl').val("");
   $('#homehalt_die_amt').val("");
   $('#homehalt_die_billtype').val("");
$('#homehalt_die_add').modal('hide');
     }
    });
...
<script>
  function diecalReta1()
  {
    if((event.keyCode||event.which) != 9)
    {


      var die1 = document.getElementById('homehalt_die_qty').value;
      var die2 = document.getElementById('homehalt_die_amt').value;
      if (die1 == "")
       die1 = 0;
     if (die2 == "")
       die2 = 0;
     ...
     if(res == true)
     {
      document.getElementById('homehalt_die_ppl').value = 0;


    }
    else
    {
      document.getElementById('homehalt_die_ppl').value=total;

    }
  }}
</script>
<script>
  function diecalReta222()
  {
    if((event.keyCode||event.which) != 9)
    {


      var die1 = document.getElementById('homehalt_upd_qty').value;
      var die2 = document.getElementById('homehalt_upd_amt').value;
      if (die1 == "")
       die1 = 0;
     if (die2 == "")
       die2 = 0;
     ...
     if(res == true)
     {
      document.getElementById('homehalt_upd_ppl').value = 0;

    }
    else
    {
      document.getElementById('homehalt_upd_ppl').value=total;
...
<div class="row mg-t-10">
      ...
      <div class="row mg-t-10">
        <label class="col-md-4 col-sm-4 form-control-label">Vendor</label>
        <div class="col-sm-8 mg-t-5 mg-sm-b-10">
          <input class="form-control" data-val="true" data-val-length="The field engineno must be a string with a maximum length of 50." data-val-length-max="50" placeholder="Vendor Name" id="return_die_vendor" maxlength="50" name="vendor" type="text" value="">
          <span class="field-validation-valid font-red" data-valmsg-for="engineno" data-valmsg-replace="true"></span>
        </div>
      </div>
<div class="row mg-t-10">
...
?>
<select class="form-control" data-val="true" placeholder="Vendor Name" id="return_die_place" name="vendor" >
<?php
...
*/
    ...
    $.ajax({    //create an ajax request to display.php
        ...
        success:function(response){ 
            ...
            $("#responsecontainer_homehalt").html(response); 
