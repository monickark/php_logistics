...
$vouc_type="Trip Advance on Trip".$_POST['refno']."Place:".$_POST['loadto']."VechNo:".$_POST['vechnum'];
...
$vouc_type="Trip Advance on Trip".$_POST['refno']."Place:".$_POST['loadto']."VechNo:".$_POST['vechnum']."-Chennai";
...
$vouc_type="Trip Advance on Trip".$_POST['refno']."Place:".$_POST['loadto']."VechNo:".$_POST['vechnum']."-MKM";
...
if(!empty($_POST['hire_diesel_adv']))
{

$vouc_type="Diesel Advance on Trip".$_POST['refno']."Place:".$_POST['loadto']."VechNo:".$_POST['vechnum'];
...
$insert_hire = array(   
      "entrytype_id"      =>     mysqli_real_escape_string($data->con, '4'),
      "number"         =>     mysqli_real_escape_string($data->con, $nos['number']+1),
      "date"          =>     mysqli_real_escape_string($data->con, $newDate),  
      "dr_total"        =>     mysqli_real_escape_string($data->con, $_POST['hire_diesel_adv']),
      "cr_total"      =>     mysqli_real_escape_string($data->con, $_POST['hire_diesel_adv']),
      "narration"    =>     mysqli_real_escape_string($data->con, $vouc_type)
...
$led_det=mysqli_query($conn,"SELECT * FROM ledgers WHERE id ='".$_POST['return_amt_place']."';" );
$led=mysqli_fetch_assoc($led_det);





$vouc_type="Return Advance on Trip".$_POST['ret_ref']."VechNo:".$_POST['vechnum']."-".$led['name'];
...
$insert_p2= array(   
      "entry_id"      =>     mysqli_real_escape_string($data->con, $insstat),
      "ledger_id"         =>     mysqli_real_escape_string($data->con, $_POST['return_amt_place']),
      "amount"        =>     mysqli_real_escape_string($data->con, $_POST['return_adv']),  
      "dc"           =>     mysqli_real_escape_string($data->con, 'D')
      );  
...
$insert_p2= array(   
      "entry_id"      =>     mysqli_real_escape_string($data->con, $insstat),
      "ledger_id"         =>     mysqli_real_escape_string($data->con, $_POST['return_emp_amt_place']),
      "amount"          =>     mysqli_real_escape_string($data->con, $_POST['ret_emp_adv']),  
      "dc"        =>     mysqli_real_escape_string($data->con, 'D')
      );  
...
<select   name="ret_emp_change_driver" id="bodytype" class="form-control"  >
        ...
        <div class="row mg-t-10">
          ...
          <div class="col-sm-8 mg-t-10 mg-sm-b-10">
           ...
           <div class="row mg-t-10">
            <label class="col-md-4 form-control-label"> Account </label>
            <div class="col-sm-8 mg-t-10 mg-sm-b-10">
<select   name="return_emp_amt_place" id="return_emp_amt_place" class="form-control"  >
                 <?php
$name =mysqli_query($conn,"SELECT * FROM ledgers WHERE type ='1'; " );
while($led_id=mysqli_fetch_assoc($name))
{

?>
     <option value="<?php echo $led_id['id']; ?>"><?php echo $led_id['name']; ?> </option>
<?php
}
    ...
    <div class="col-xl-6">
      ...
      <div class="portlet-body">
        ...
        <div class="row mg-t-10">
          ...
          <label class="col-md-2 form-control-label">Weight Bill Charges </label>
          <div class="col-sm-4 mg-t-5 mg-sm-b-10">
        ...
        <div class="row mg-t-10">
          <label class="col-md-2 form-control-label">Other Charges </label>
          <div class="col-sm-4 mg-t-5 mg-sm-b-10">
      ...
      <div class="col-xl-5 col-lg-12">
        ...
        <div class="portlet-body">
          ...
          <div class="row mg-t-10">
           ...
           <div class="row mg-t-10">
            <label class="col-md-2 col-sm-2 form-control-label"> Account </label>
            <div class="col-sm-10 mg-t-10 mg-sm-b-10">
...
/*  var elem = document.getElementById("ID_UNIQUE").value = randomNum;*/
 ...
 <input class="form-control input emp_val" data-val="true" placeholder="Enter From Place" id="from_main" maxlength="50" name="loadfrom" type="text" autocomplete="off" >
...
var hidden_fields = $( x[currentFocus] ).find( 'input:hidden' ).val();

document.getElementById("from_main").value=hidden_fields;
/*document.getElementById("from_main").value = "Johnny Bravo";*/

        /*and and make the current item more visible:*/
        addActive(x);
/*
var sd= x[currentFocus];*/
/*alert(sd);*/
...
var x = document.getElementById("from_mainautocomplete-list");

x.style.display = "none";

/*"to_mainautocomplete2-list"*/
  ...
  function addActive(x) {
    ...
    /*var xx=x[currentFocus].classList;*/
...
autocomplete(document.getElementById("from_main"), countries);
 ...
 <input class="form-control emp_val" data-val="true" placeholder="Enter From Place" id="to_main" maxlength="50" name="loadto" type="text" autocomplete="off">
...
document.getElementById("to_main").value=hidden_fields;
        /*and and make the current item more visible:*/
        addActive2(x);
      } else if (e.keyCode == 38) { //up
        /*If the arrow UP key is pressed,
...
var x = document.getElementById("to_mainautocomplete2-list");
...
autocomplete2(document.getElementById("to_main"), countries);
...
/*          alert(data);*/
   ...
   <div class="row mg-t-10">
             <label class="col-md-2 form-control-label" > Driver  </label>
             <div class="col-sm-4 mg-t-5 mg-sm-b-10">
              <select name="loaddriver" id="loaddriver" class="form-control emp_val" style="background-color:#864e24;color: white;">
                <option value="">Select </option>
                <?php $query =mysqli_query($conn,"SELECT * FROM drivers ");
                while($row=mysqli_fetch_array($query))
                 { ?>
            ...
            <div id="modaldemo1" class="modal fade">
              <div class="modal-dialog modal-dialog-vertical-center" role="document">
                <div class="modal-content bd-0 tx-14">
                  ...
                  <div class="modal-body pd-25">
                   <div class="row mg-t-10">
                    ...
                    <div class="col-sm-10 mg-t-5 mg-sm-b-10">
                      <input class="form-control emp_val_gc" data-val="true" data-val-length="The field bodytype must be a string with a maximum length of 100." data-val-length-max="100" placeholder="Enter GC Number" id="ass_gc" maxlength="100" name="assgc" value="" type="text"  >
                      <span class="field-validation-valid font-red" data-valmsg-for="bodytype" data-valmsg-replace="true"></span>
                    </div>
                  </div>  
                  ...
                  <div class="row mg-t-10">
                    ...
                    <div class="col-sm-10 mg-t-5 mg-sm-b-10">
                     <select   name="gcconsignor" id="consignor_name" class="form-control emp_val_gc"  >
                       <option value="">Select </option>
                       <?php $query =mysqli_query($conn,"SELECT * FROM customer ");
                       while($row=mysqli_fetch_array($query))
                        { ?>
                  ...
                  <div class="row mg-t-10">
                   ...
                   <div class="col-sm-10 mg-t-5 mg-sm-b-10">
                    <select   name="gcconsignee" id="consignee_name" class="form-control emp_val_gc"  >
                     <option value="">Select </option>
                     <?php $query =mysqli_query($conn,"SELECT * FROM customer ");
                     while($row=mysqli_fetch_array($query))
                      { ?>
                ...
                <div class="row mg-t-10">
                 ...
                 <div class="col-sm-4 mg-t-5 mg-sm-b-10">
                  <input class="form-control emp_val_gc" data-val="true" data-val-length="The field permitno must be a string with a maximum length of 50." data-val-length-max="50" placeholder="No. of Articles" id="gc_articles" maxlength="50" name="gcarticles" type="text" value="" >
                  <span class="field-validation-valid font-red" data-valmsg-for="permitno" data-valmsg-replace="true"></span>
                </div>

                <label class="col-md-2 form-control-label"> Value  </label>
                <div class="col-sm-4 mg-t-5 mg-sm-b-10">
                  <input class="form-control emp_val_gc" data-val="true" data-val-length="The field permitno must be a string with a maximum length of 50." data-val-length-max="50" placeholder="Goods Value." id="gc_value" maxlength="50" name="gcvalue" type="text" value="" >
                  <span class="field-validation-valid font-red" data-valmsg-for="permitno" data-valmsg-replace="true"></span>
                </div> </div>
                ...
                <div class="modal-footer">
                  <button type="button" id="addgc" class="btn btn-info pd-x-20"  >Done</button>
                  <button type="button" class="btn btn-secondary pd-x-20" data-dismiss="modal">Close</button>
                </div>
              </div></div>
<script>
$('.emp_val_gc').on('input blur change', function() {
  var input= $(this);
...
<script>
$('#gc_value').on('input blur change', function() {
  var input= $(this);
  var is_name=input.val();
/*alert(is_name);*/
...
<script>
$('#gc_articles').on('input blur change', function() {
  var input= $(this);
  var is_name=input.val();
/*alert(is_name);*/

var value=$('#gc_articles').val();
if (isNaN(is_name)) {
  /*alert("is not numeric")*/
/*input.removeClass("valid").addClass("invalid");*/
...
<script>
  ...
  $(document).on('click','#addgc', function(e){
      ...
      $("#gcdiv").html(data);
          ...
          <div class="row mg-t-10">
           ...
           <div class="col-sm-10 mg-t-5 mg-sm-b-10">
             ...
             <select   name="loadparty" id="insurancename" class="form-control emp_val" onchange="bankfetch(this.value)" >
                 <option value="">Select </option>
                 <?php $query =mysqli_query($conn,"SELECT * FROM customer ");
                 while($row=mysqli_fetch_array($query))
                  { ?>
        ...
        <div class="row mg-t-10">
          ...
          <div class="portlet-body">
           <div class="row mg-t-10">
             <label class="col-md-2 form-control-label">GC No </label>
             <div class="col-sm-10 mg-t-5 mg-sm-b-10">
              <input class="form-control emp_val" data-val="true" data-val-length="The field permitno must be a string with a maximum length of 50." data-val-length-max="50" placeholder="Enter GC Number" id="permitno" maxlength="50" name="loadgcno" type="text" value="">
              <span class="field-validation-valid font-red" data-valmsg-for="permitno" data-valmsg-replace="true"></span>
          ...
          <div class="row mg-t-10">
            <label class="col-md-2 form-control-label">Reference No </label>
            <div class="col-sm-4 mg-t-5 mg-sm-b-10">
              <input class="form-control emp_val" data-val="true" data-val-length="The field insurancename must be a string with a maximum length of 200." data-val-length-max="200" placeholder="Enter Reference Number" id="insurancename" maxlength="200" name="loadrefno" type="text" value="">
              <span class="field-validation-valid font-red" data-valmsg-for="insurancename" data-valmsg-replace="true"></span>
            </div>

            <label class="col-md-2 form-control-label">Container No </label>
            <div class="col-sm-4 mg-t-5 mg-sm-b-10">
              <input class="form-control emp_val" data-val="true" data-val-length="The field permitno must be a string with a maximum length of 50." data-val-length-max="50" placeholder="Enter Container Number" id="ldcontno" maxlength="50" name="loadcontno" type="text" value="" onkeypress="return onlyAlphabets(event,this);">
          ...
          <div class="row mg-t-10">
            <label class="col-md-2 form-control-label">Container Size </label>
            <div class="col-sm-4 mg-t-5 mg-sm-b-10">
             <select class="form-control emp_val" data-val="true" data-val-number="The field maritialstatus must be a number." placeholder="The maritialstatus field is required." id="mstatus" name="loadcontsize">
              <option value="">---Select Container Size---</option>
              <option <?php if($insid[0]['maritialstat']=="1") echo 'selected="selected"'; ?> selected="selected" value="20">20</option>
              <option <?php if($insid[0]['maritialstat']=="2") echo 'selected="selected"'; ?> value="40">40</option>
          ...
          <label class="col-md-2 form-control-label">Container Weight </label>
          <div class="col-sm-4 mg-t-5 mg-sm-b-10">
            <input class="form-control emp_val" data-val="true" data-val-length="The field permitno must be a string with a maximum length of 50." data-val-length-max="50" placeholder="Enter Container Weight" id="loadcontwt" maxlength="50" name="loadcontwt" type="text" value="">
            <span class="field-validation-valid font-red" data-valmsg-for="permitno" data-valmsg-replace="true"></span>
...
<script>
$('#loadcontwt').on('input blur change', function() {
  var input= $(this);
  var is_name=input.val();
/*alert(is_name);*/

var value=$('#loadcontwt').val();
if (isNaN(is_name)) {
  /*alert("is not numeric")*/
/*input.removeClass("valid").addClass("invalid");*/
      ...
      <div class="portlet-body">
        ...
        <div class="col-md-4">
         ...
         <div class="row mg-t-10">
          <label class="col-md-2 form-control-label">Freight Amount </label>
          <div class="col-sm-4 mg-t-5 mg-sm-b-10">
            <input class="amt_cal form-control onlynos emp_val" data-val="true" data-val-length="The field insurancename must be a string with a maximum length of 200." data-val-length-max="200" placeholder="Enter Freight Amount" id="lfreightamt" maxlength="200" name="frt_amt" type="text" value="" onkeyup= "fintot()">
            <span class="field-validation-valid font-red" data-valmsg-for="insurancename" data-valmsg-replace="true"></span>
          </div>

          <label class="col-md-2 form-control-label">Loading Charges </label>
          <div class="col-sm-4 mg-t-5 mg-sm-b-10">
            <input class="amt_cal form-control onlynos" data-val="true" data-val-length="The field permitno must be a string with a maximum length of 50." data-val-length-max="50" placeholder="Loading Charges" id="lldngcgs" maxlength="50" name="frt_ldg_chrg" type="text" value="" onkeyup= "fintot()" >
            <span class="field-validation-valid font-red" data-valmsg-for="permitno" data-valmsg-replace="true"></span>
          </div>
        </div>
        ...
        <div class="row mg-t-10">
          <label class="col-md-2 form-control-label">Un-Loading Charges </label>
          <div class="col-sm-4 mg-t-5 mg-sm-b-10">
            <input class="amt_cal form-control onlynos" data-val="true" data-val-length="The field insurancename must be a string with a maximum length of 200." data-val-length-max="200" placeholder="Enter Un Loading Charges" id="luldngcgs" maxlength="200" name="frt_unldg_chrg" type="text" value="" onkeyup= "fintot()" >
            <span class="field-validation-valid font-red" data-valmsg-for="insurancename" data-valmsg-replace="true"></span>
          </div>

          <label class="col-md-2 form-control-label">Weight Bill Charges </label>
          <div class="col-sm-4 mg-t-5 mg-sm-b-10">
            <input class="amt_cal form-control onlynos" data-val="true" data-val-length="The field permitno must be a string with a maximum length of 50." data-val-length-max="50" placeholder="Weigh Bill Charges" id="lwbillcgs" maxlength="50" name="frt_weigh_crg" type="text" value="" onkeyup= "fintot()" >
            <span class="field-validation-valid font-red" data-valmsg-for="permitno" data-valmsg-replace="true"></span>
          </div>
        </div>
        ...
        <div class="row mg-t-10">
          ...
          <div class="col-sm-4 mg-t-5 mg-sm-b-10">
            ...
            <input class="amt_cal form-control onlynos" data-val="true" data-val-length="The field permitno must be a string with a maximum length of 50." data-val-length-max="50" placeholder="Other Amount" id="lotramt" maxlength="50" name="frt_other_crg" type="text" value="" onkeyup= "fintot()" >
            <span class="field-validation-valid font-red" data-valmsg-for="permitno" data-valmsg-replace="true"  ></span> </div>

            <label class="col-md-2 form-control-label">Other Description</label>
            <div class="col-sm-4 mg-t-5 mg-sm-b-10">
              <input class="form-control onlynos" data-val="true" data-val-length="The field insurancename must be a string with a maximum length of 200." data-val-length-max="200" placeholder="Description" id="lodes" maxlength="200" name="frt_other_desc" type="text" value="" >
              <span class="field-validation-valid font-red" data-valmsg-for="insurancename" data-valmsg-replace="true"></span>
            </div>
          </div>
          ...
          <div class="row mg-t-10">
            <label class="col-md-2 form-control-label">Halt Days </label>
            <div class="col-sm-4 mg-t-5 mg-sm-b-10">
              <input class="form-control onlynos" data-val="true" data-val-length="The field insurancename must be a string with a maximum length of 200." data-val-length-max="200" placeholder="Halt Days" id="lhltdays" maxlength="200" name="frt_hlt_days" type="text" value="" onkeyup="fval()" readonly >
              <span class="field-validation-valid font-red" data-valmsg-for="insurancename" data-valmsg-replace="true"></span>
            </div>

            <label class="col-md-2 form-control-label">Rate </label>
            <div class="col-sm-4 mg-t-5 mg-sm-b-10">
              <input class="form-control onlynos" data-val="true" data-val-length="The field permitno must be a string with a maximum length of 50." data-val-length-max="50" placeholder="Halt Rate" id="hltrate" maxlength="50" name="frt_hlt_rate" type="text" value="" readonly
              onkeyup="fval()" >
              <span class="field-validation-valid font-red" data-valmsg-for="permitno" data-valmsg-replace="true"></span>
            </div>
          </div>
          ...
          <div class="row mg-t-10">
            ...
            <label class="col-md-2 form-control-label">Halt Amount </label>
            <div class="col-sm-10 mg-t-5 mg-sm-b-10">
              <input class="amt_cal form-control onlynos" data-val="true" data-val-length="The field bodytype must be a string with a maximum length of 100." data-val-length-max="100" placeholder="0" id="lhltamt" maxlength="100" name="fhltamt" value="" type="text" disabled >
              <input class="amt_cal form-control onlynos" data-val="true" data-val-length="The field bodytype must be a string with a maximum length of 100." data-val-length-max="100" placeholder="0" id="lhltamth" maxlength="100" name="frt_hlt_amt" value="" type="hidden"  >
              <span class="field-validation-valid font-red" data-valmsg-for="bodytype" data-valmsg-replace="true"></span>
            </div>
          </div>
          ...
          <div class="row mg-t-10">
            ...
            <label class="col-md-2 form-control-label">Total Frieght </label>
            <div class="col-sm-10 mg-t-5 mg-sm-b-10">
              <input class="form-control onlynos" data-val="true" data-val-length="The field bodytype must be a string with a maximum length of 100." data-val-length-max="100" placeholder="Total Amount" id="ttlfreight" maxlength="100" name="fttlfreighth" value="" type="text" disabled >
              <input class="form-control onlynos" data-val="true" data-val-length="The field bodytype must be a string with a maximum length of 100." data-val-length-max="100" placeholder="Total Amount" id="ttlfreighth" maxlength="100" name="frt_total" value="" type="hidden" >
              <span class="field-validation-valid font-red" data-valmsg-for="bodytype" data-valmsg-replace="true"></span>
            </div>
          </div>
...
<div class="col-xl-6">
 ...
 <div class="row mg-t-10">
            ...
            <div class="col-sm-4 mg-t-5 mg-sm-b-10">
              <input class="form-control onlynos" data-val="true" data-val-length="The field insurancename must be a string with a maximum length of 200." data-val-length-max="200" placeholder="0" id="advcsh" maxlength="200" name="frt_adv_cash" type="text" value="" onkeyup="totval()">
              <span class="field-validation-valid font-red" data-valmsg-for="insurancename" data-valmsg-replace="true"></span>
            </div>
            <div class="col-sm-6 mg-t-5 mg-sm-b-10">
             <div class="input-group">
      ...
      <div class="portlet-body">
        ...
        <div class="col-md-4">
         ...
         <div class="row mg-t-10">
          <label class="col-md-2 form-control-label">Hire Amount </label>
          <div class="col-sm-4 mg-t-5 mg-sm-b-10">
            <input class="form-control onlynos" data-val="true" data-val-length="The field insurancename must be a string with a maximum length of 200." data-val-length-max="200" placeholder="Enter Hire Amount" id="hire_amt" maxlength="200" name="hire_amt" type="text" value="" onkeyup="hiretot()" readonly>
            <span class="field-validation-valid font-red" data-valmsg-for="insurancename" data-valmsg-replace="true"></span>
          </div>
          ...
          <div class="col-sm-4 mg-t-5 mg-sm-b-10">
            <input class="form-control onlynos" data-val="true" data-val-length="The field permitno must be a string with a maximum length of 50." data-val-length-max="50" placeholder="Commission" id="hire_comm" maxlength="50" name="hire_comm" type="text" value="500" onkeyup="hiretot()" >
            <span class="field-validation-valid font-red" data-valmsg-for="permitno" data-valmsg-replace="true"></span>
          </div>
        </div>
        ...
        <div class="row mg-t-10">
          <label class="col-md-2 form-control-label">Loading Charges </label>
          <div class="col-sm-4 mg-t-5 mg-sm-b-10">
            <input class="form-control onlynos" data-val="true" data-val-length="The field permitno must be a string with a maximum length of 50." data-val-length-max="50" placeholder="Loading Charges" id="hire_ldng_crgs" maxlength="50" name="hire_ldng_crgs" type="text" value="" onkeyup="hiretot()" readonly>
            <span class="field-validation-valid font-red" data-valmsg-for="permitno" data-valmsg-replace="true"></span>
          </div>

          <label class="col-md-2 form-control-label">Un-Loading Charges </label>
          <div class="col-sm-4 mg-t-5 mg-sm-b-10">
            <input class="form-control onlynos" data-val="true" data-val-length="The field insurancename must be a string with a maximum length of 200." data-val-length-max="200" placeholder="Un-Loading Charges" id="hire_unldng_crgs" maxlength="200" name="hire_unldng_crgs" type="text" value="" onkeyup="hiretot()" readonly>
            <span class="field-validation-valid font-red" data-valmsg-for="insurancename" data-valmsg-replace="true"></span>
          </div>  
        </div>
        ...
        <div class="row mg-t-10">
          <label class="col-md-2 form-control-label">Weight Bill Charges </label>
          <div class="col-sm-4 mg-t-5 mg-sm-b-10">
            <input class="form-control onlynos" data-val="true" data-val-length="The field permitno must be a string with a maximum length of 50." data-val-length-max="50" placeholder="Weigh Bill Charges" id="hire_weigh_crgs" maxlength="50" name="hire_weigh_crgs" type="text" value="" onkeyup="hiretot()" >
            <span class="field-validation-valid font-red" data-valmsg-for="permitno" data-valmsg-replace="true"></span>
          </div></div>
          <div class="row mg-t-10">
            <label class="col-md-2 form-control-label">Other Charges </label>
            <div class="col-sm-4 mg-t-5 mg-sm-b-10">
              <input class="form-control onlynos" data-val="true" data-val-length="The field permitno must be a string with a maximum length of 50." data-val-length-max="50" placeholder="Other Amount" id="hire_other_amt" maxlength="50" name="hire_other_amt" type="text" value="" onkeyup="hiretot()" >
              <span class="field-validation-valid font-red" data-valmsg-for="permitno" data-valmsg-replace="true"></span>
            </div>

            <label class="col-md-2 form-control-label">Other Description</label>
            <div class="col-sm-4 mg-t-5 mg-sm-b-10">
              <input class="form-control" data-val="true" data-val-length="The field insurancename must be a string with a maximum length of 200." data-val-length-max="200" placeholder="Description" id="hire_other_des" maxlength="200" name="hire_other_des" type="text" value="" >
              <span class="field-validation-valid font-red" data-valmsg-for="insurancename" data-valmsg-replace="true"></span>
            </div>
          </div>
          ...
          <div class="row mg-t-10">
            <label class="col-md-2 form-control-label">Halt Days </label>
            <div class="col-sm-4 mg-t-5 mg-sm-b-10">
              <input class="form-control onlynos" data-val="true" data-val-length="The field insurancename must be a string with a maximum length of 200." data-val-length-max="200" placeholder="Halt Days" id="hire_halt_days" maxlength="200" name="hire_halt_days" type="text" value="" onkeyup="htot()" readonly>
              <span class="field-validation-valid font-red" data-valmsg-for="insurancename" data-valmsg-replace="true"></span>
            </div>

            <label class="col-md-2 form-control-label">Rate </label>
            <div class="col-sm-4 mg-t-5 mg-sm-b-10">
              <input class="form-control onlynos" data-val="true" data-val-length="The field permitno must be a string with a maximum length of 50." data-val-length-max="50" placeholder="Halt Rate" id="hire_halt_rate" maxlength="50" name="hire_halt_rate" type="text" value="" onkeyup="htot()" readonly>
              <span class="field-validation-valid font-red" data-valmsg-for="permitno" data-valmsg-replace="true"></span>
            </div>
          </div>
          ...
          <div class="row mg-t-10">
            ...
            <label class="col-md-2 form-control-label">Halt Amount </label>
            <div class="col-sm-10 mg-t-5 mg-sm-b-10">
              <input class="form-control onlynos" data-val="true" data-val-length="The field bodytype must be a string with a maximum length of 100." data-val-length-max="100" placeholder="0" id="hire_halt_value" maxlength="100" name="hire_halt_value" value="" type="text"  >
              <input class="form-control onlynos" data-val="true" data-val-length="The field bodytype must be a string with a maximum length of 100." data-val-length-max="100" placeholder="0" id="hire_halt_amt" maxlength="100" name="hire_halt_amt" value="" type="hidden" >
              <span class="field-validation-valid font-red" data-valmsg-for="bodytype" data-valmsg-replace="true"></span>
            </div>
          </div>
          ...
          <div class="row mg-t-10">
            ...
            <label class="col-md-2 form-control-label">Total Frieght </label>
            <div class="col-sm-10 mg-t-5 mg-sm-b-10">
              <input class="form-control onlynos" data-val="true" data-val-length="The field bodytype must be a string with a maximum length of 100." data-val-length-max="100" placeholder="Total Amount" id="hire_total" maxlength="100" name="hire_total" value="" type="text" readonly  >
              <input class="form-control onlynos" data-val="true" data-val-length="The field bodytype must be a string with a maximum length of 100." data-val-length-max="100" placeholder="Total Amount" id="hire_frt_total" maxlength="100" name="hire_frt_total" value="" type="hidden">
              <span class="field-validation-valid font-red" data-valmsg-for="bodytype" data-valmsg-replace="true"></span>
            </div>
          </div>
              ...
              <div class="col-md-4">
               ...
               <div class="row mg-t-10">
                ...
                <div class="row mg-t-10">
                  <label class="col-md-2 form-control-label">Chn. Advance </label>
                  <div class="col-sm-4 mg-t-5 mg-sm-b-10">
                    <input class="form-control onlynos" data-val="true" data-val-length="The field insurancename must be a string with a maximum length of 200." data-val-length-max="200" placeholder="0" id="hire_adv" maxlength="200" name="hire_adv" type="text" value="" onkeyup="totadvval()">
                    <span class="field-validation-valid font-red" data-valmsg-for="insurancename" data-valmsg-replace="true"></span>
                  </div>
                  <label class="col-md-2 form-control-label">Pay Type </label>
                  <div class="col-sm-4 mg-t-5 mg-sm-b-10">
...
/*alert(data);*/
 ...
 <select class="form-control" data-val="true" data-val-number="The field maritialstatus must be a number." placeholder="The maritialstatus field is required." id="hire_chn_bank" name="hire_chn_bank" >
                ...
                <div class="row mg-t-10">
                  <label class="col-md-2 form-control-label">MKM Advance </label>
                  <div class="col-sm-4 mg-t-5 mg-sm-b-10">
                    <input class="form-control onlynos" data-val="true" data-val-length="The field insurancename must be a string with a maximum length of 200." data-val-length-max="200" placeholder="0" id="hire_mkm_amt" maxlength="200" name="hire_mkm_amt" type="text" value="" onkeyup="totadvval()">
                    <span class="field-validation-valid font-red" data-valmsg-for="insurancename" data-valmsg-replace="true"></span>
                  </div>
                  <label class="col-md-2 form-control-label">Pay Type </label>
                  <div class="col-sm-4 mg-t-5 mg-sm-b-10">
...
alert(upd_amt);*/
 ...
 $('#hire_diesel_adv').val(upd_amt);
                ...
                <div class="row mg-t-10">
                  <label class="col-md-2 form-control-label">Diesel Adv.:</label>
                  <div class="col-sm-4 mg-t-5 mg-sm-b-10">
                    <input class="form-control onlynos" data-val="true" data-val-length="The field permitno must be a string with a maximum length of 50." data-val-length-max="50" placeholder="0" id="hire_diesel_adv" maxlength="50" name="hire_diesel_adv" type="text" value="" onkeyup="hirebal()">
                  ...
                  <label class="col-md-2 form-control-label">Diesel Qty.:</label>
                  <div class="col-sm-4 mg-t-5 mg-sm-b-10">
                    <input class="form-control onlynos" data-val="true" data-val-length="The field permitno must be a string with a maximum length of 50." data-val-length-max="50" placeholder="0" id="hire_diesel_qty" maxlength="50" name="hire_diesel_qty" type="text" value="">
                    <span class="field-validation-valid font-red" data-valmsg-for="permitno" data-valmsg-replace="true"></span>
                  </div>
                </div>
...
<div class="form-layout-footer" id="submitdiv" style="padding-top:  0;     padding: 18px 30px 28px;">
                ...
                <button type="submit" id="sub" value="submit" name="submit" class="btn btn-info mg-r-5">Submit</button>
                <input type="hidden" name="action" value="<?php if($_REQUEST['flag'] =='Edit') echo $_REQUEST['flag']; else echo 'Add'; ?>">
                <button class="btn btn-secondary">Cancel</button>
              </div>
</div>
...
<script>
$('.onlynos').on('input blur change', function() {
  var input= $(this);
  var is_name=input.val();
...
$('.emp_val').on('input blur change', function() {
  ...
  var is_name=input.val();
/*alert(is_name);*/
  if(is_name){input.removeClass("invalids").addClass("valids");}
  else{input.removeClass("valids").addClass("invalids");}
});
...
<!-- 
<style>
  input.invalids, select.invalids,textarea.invalids{
  border: 2px solid red;
}
input.valids, textarea.valids{
  border-radius: 0 ;
}
</style>
 -->
...
/*  alert(id);*/
  ...
  input.removeClass("valids").addClass("invalids");
  e.preventDefault();
  break;
    }
